...
\section{Caratteristiche del robot}
...
\begin{table}[htbp!]
    ...
    \hline
         \rowcolor{lightgray} \textbf{Caratteristiche giunti}  & \textbf{Motion range [\degree]} & \textbf{velocità max [\degree/s]}\\
         \hline
        Giunto 1 (R) & 300     & 440 \\
        Giunto 2 (R) & 300     & 500 \\
...
\begin{tabularx}{\textwidth}{|C|C|C|C|}
	\hline
     \rowcolor{lightgray} \textbf{Caratteristiche link} & \textbf{Lunghezza} $\boldsymbol{[mm]}$ & \textbf{Massa [kg] - \textit{inerzia} [$\boldsymbol{kgm^2}$]} & \textbf{Posizione baricentro dal link precedente}$\boldsymbol{[mm]}$ \\
     \hline
    Base & 300* & - & -\\
